...
function validateForm() {
	...
	var code = document.getElementById("professionCode");
	var proField = document.getElementById("proFieldID");
	
	if(code.value == ''){
		alert("Please Set a Profession Code");
		code.focus();
		return false;
	}
	
	if(proField.value == ''){
		alert("Please Set a Professional Field");
		code.focus();
		return false;
	}
