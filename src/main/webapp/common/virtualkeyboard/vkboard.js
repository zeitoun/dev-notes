...
function VKeyboard(container_id, callback_ref, create_numpad, language, font_name,
                   ...
                   do_embed)
{
  return this._construct(container_id, callback_ref, create_numpad,
                         language, font_name, font_size, font_color, dead_color,
...
VKeyboard.prototype = {
  ...
  _construct: function(container_id, callback_ref, create_numpad, language, font_name, font_size, font_color, dead_color,
                       ...
                       lang_sel_brd_color, show_click, click_font_color, click_bg_color, click_border_color, do_embed)
  {
    ...
    var bc = border_color || this.bordercolor || "FFF";
    ...
    if(!exists || changed)
    {
      ...
      var kb_kbp = this._setup_key(kb_main, "___kbp", "1px", (prevX + prevW + 1) + "px", (3.3 * cell) + "px", cp, r, lh, fs, n, "", pad);
      kb_kbp.innerHTML = "Backspace";
      this.mod[0] = kb_kbp;

      // Top row:

      var kb_tab = this._setup_key(kb_main, "___tab", (prevY + prevH + 1) + "px", "1px", dcell + "px", cp, l, lh, fs, n, pad);
      ...
      var kb_caps = this._setup_key(kb_main, "___caps", (prevY + prevH + 1) + "px", "1px", dcell + cell  + "px", cp, l, lh, fs, n, pad);
     ...
     //this.mod[9] = kb_res_2;
      ...
      var kb_space = this._setup_key(kb_main, "___space", prevY, (this._findX(kb_lang) + this._findW(kb_lang) + dcell + 1) + "px", (6.28 * cell) + "px", cp, c, lh, fs);
	  this.mod[8] = kb_space;
  ...
  _generic_callback_proc: function(event)
  {
    ...
    if(val != 'Backspace' && source.maxLength)
  	{
  		if(eval(source.value.length+1)>source.maxLength) return false;
  	}
  ...
  avail_langs: [["Eng", "English (US)"], ["Arb", "&#1575;&#1604;&#1593;&#1585;&#1576;&#1610;&#1577;"]],

  // Us International:

  Eng_normal: ["&#x0060;", "&#x0031;", "&#x0032;", "&#x0033;", "&#x0034;", "&#x0035;", "&#x0036;", "&#x0037;", "&#x0038;", "&#x0039;", "&#x0030;", "&#x002D;", "&#x003D;",
              "&#x0071;", "&#x0077;", "&#x0065;", "&#x0072;", "&#x0074;", "&#x0079;", "&#x0075;", "&#x0069;", "&#x006F;", "&#x0070;", "&#x005B;", "&#x005D;", "&#x005C;",
              "&#x0061;", "&#x0073;", "&#x0064;", "&#x0066;", "&#x0067;", "&#x0068;", "&#x006A;", "&#x006B;", "&#x006C;", "&#x003B;", "&#x0027;",
              "&#x007A;", "&#x0078;", "&#x0063;", "&#x0076;", "&#x0062;", "&#x006E;", "&#x006D;", "&#x002C;", "&#x002E;", "&#x002F;"],

  Eng_caps: ["&#x0060;", "&#x0031;", "&#x0032;", "&#x0033;", "&#x0034;", "&#x0035;", "&#x0036;", "&#x0037;", "&#x0038;", "&#x0039;", "&#x0030;", "&#x002D;", "&#x003D;",
            "&#x0051;", "&#x0057;", "&#x0045;", "&#x0052;", "&#x0054;", "&#x0059;", "&#x0055;", "&#x0049;", "&#x004F;", "&#x0050;", "&#x005B;", "&#x005D;", "&#x005C;",
            "&#x0041;", "&#x0053;", "&#x0044;", "&#x0046;", "&#x0047;", "&#x0048;", "&#x004A;", "&#x004B;", "&#x004C;", "&#x003B;", "&#x0027;",
            "&#x005A;", "&#x0058;", "&#x0043;", "&#x0056;", "&#x0042;", "&#x004E;", "&#x004D;", "&#x002C;", "&#x002E;", "&#x002F;"],
 ...
 Arb_normal: ["&#x0630;","&#x0661;","&#x0662;","&#x0663;","&#x0664;","&#x0665;","&#x0666;","&#x0667;","&#x0668;","&#x0669;","&#x0660;","&#x002D;","&#x003D;",
     ...
     switch(ch)
     {
       ...
       case "Enter":
	    if(source.tagName == "INPUT"){
         login(document.getElementById("userNo").value, document.getElementById("userPwd").value);
         return;}
		else
		  source.value += "\n";	
         break;
