...
c_imagesPath=APP_ROOT+"clientassets/files_optica/assets/menu/"; // path to the directory containing the menu images
...
'#C4C4C4',	// OVER Background
'#00529B',	// Color
'#00529B',	// OVER Color
'14px',		// FontSize (values in CSS valid units - %,em,ex,px,pt)
'Tahoma, Geneva, sans-serif',	// FontFamily
...
'',		// CURRENT BorderStyle
'',		// CURRENT BorderColor
'C4C4C4',		// CURRENT Background('color', 'transparent')
'#00529B',		// CURRENT Color
...
'',	// OVER BorderColor
5,		// Padding
'#CACACA',	// Background ('color','transparent','[image_source]')
'#C01414',	// OVER Background
'#000000',	// Color
'#FFFFFF',	// OVER Color
'14px',		// FontSize (values in CSS valid units - %,em,ex,px,pt)
'Arial',	// FontFamily
...
'1.0em',		// X Position (values in CSS valid units- px,em,ex)
'8.1em',		// Y Position (values in CSS valid units- px,em,ex)
...
'10',			// SubMenuImageVAlign ('pixels from item top','middle')
'',		// solid VISITED BorderStyle
'',		// #00529B VISITED BorderColor
'',		// #00529B VISITED Background
...
'solid',	// ItemsSeparatorStyle (border-style valid values)
'#F88F1D',	// ItemsSeparatorColor ('color','transparent')
